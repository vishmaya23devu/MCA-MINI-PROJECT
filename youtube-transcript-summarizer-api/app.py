...
def respond():
    ...
    # Now the user has given a valid video id
        ...
        if nlp_model(video_id) == "0":
            ...
            data['id'] = video_id
            data['original_txt_length'], data['final_summ_length'], data['eng_summary'], data['hin_translated_summary'], data['mal_translated_summary'],data['tam_translated_summary'] = nlp_model(
                video_id)
            print(data)
